...
//    WebElement btnOkSupplier;
    ...
    @FindBy(xpath="//button[contains(@id,'msgDlg::ok')]")
  ...
  //R12 AND R13 Journals
	...
	//R13 Create Purchase Req  //a[contains(text(),'More Tasks')]
		@FindBy(xpath="//a[contains(text(),'More Tasks')]")
		WebElement lstMoreTasks;
		@FindBy(xpath="//td[contains(text(),'Enter Requisition Line')]")
		WebElement lnkEnterReqLine;
		@FindBy(xpath="//span[contains(text(),'Add to Cart')]//parent::a")
		WebElement btnAddCart;  
		@FindBy(xpath="//img[@title='Shopping Cart']")
		WebElement btnShoppingCart;     
		@FindBy(xpath="//button[text()='Review']")             
		WebElement btnReview; 
		@FindBy(xpath="//button[text()='OK']//following-sibling::button[1]")
    ...
    public void createItemBasedRequisition() throws Exception {    	
        ...
        try {
			...
			Thread.sleep(3000);
			Utility.ng_clickWebElement(lstMoreTasks,"Requisition Line Entry","RequisitionLineEntryClick"); //lnkEnterReqLine
			Utility.ng_clickWebElement(lnkEnterReqLine,"Requisition Line Entry","RequisitionLineEntryClick");
			
			//Utility.waitForPageToLoad();
			Utility.ng_verifyPage("Requisition", "RequisitionCheck");
			//Utility.ng_clickWebElement(elmSearchIcon, "Search Icon", "SearchIconClick");
			//Utility.ng_selectWindow("WindowSelect");
			//Utility.waitForPageToLoad();

			//Utility.ng_enterText(edtItem, "Item", "ItemSet");
			...
			Utility.ng_enterText(edtPrice, "Price", "PriceSet");    	    
			//Utility.ng_SelectList(edtCurrency, "Currency","CurrencySet");
			//Utility.ng_typeAndTab(edtCurrency, "Currency","CurrencySet");

			Utility.ng_clickWebElement(btnAddCart, "Add to Requisition", "AddtoRequisitionClick");
			Utility.waitForPageToLoad();  //btnShoppingCart//btnReview
			//Utility.ng_clickUsingActions(btnShoppingCart, "Shopping Cart", "ShoppingCartClick");
			//Thread.sleep(1000);
			Utility.ng_clickElementUsingJS(btnShoppingCart, "Shopping Cart", "ShoppingCartClick");
			Utility.ng_clickElementUsingJS(btnReview, "Review", "ReviewClick");
			//Utility.ng_clickWebElement(btnReview, "Review", "ReviewClick");
			Thread.sleep(9000);
			//Utility.ng_getElementText(elmRequisitionNumber, "Requisition Number", "RequisitionNumberGet");
			//Utility.ng_clickWebElement(btnEditAndSubmit, "Edit And Submit", "EditAndSubmitClick");
			Utility.ng_clickWebElement(btnSave, "Save", "SaveClick");
			Utility.ng_clickWebElement(btnCheckFunds, "CheckFunds", "CheckFundsClick");
			Utility.ng_clickWebElement(btnConfirmationOk, "Confirmation Ok", "ConfirmationOkClick");
			//Utility.ng_waitImplicitly(2);
			Utility.ng_clickWebElement(btnManageApprovals, "Manage Approvals", "ManageApprovalsClick");
			//Utility.ng_waitImplicitly(2);
			//Utility.ng_clickUsingActions(btnBack, "Back", "BackClick");
			Utility.ng_clickWebElement(btnSubmit, "Submit", "SubmitClick");
			...
			ReqNo=Utility.ng_getDigitsFromString(s);
			System.out.println(ReqNo);
			Utility.ng_clickWebElement(btnConfOk, "Confirmation Ok", "ConfOk");     	    
		} catch (Exception e) {
			Global.objErr = "11";
		}       
    }
    ...
    public void createPurchaseOrder() throws Exception {    	
        ...
        try {
			...
			{
			Global.gstrReadfromTestData = false;
			Utility.ng_enterText(edtRequisition, "Requisition", ReqNo);
			System.out.println(ReqNo);
			Global.gstrReadfromTestData = true;
			}
			else
			{
				Utility.ng_enterText(edtRequisition, "Requisition", "RequisitionSet");	
			}
    	    ...
    	    Utility.ng_clickWebElement(btnSearchRequisition, "Search Requisition", "SearchRequisitionClick");
    	    Utility.ng_clickWebElement(elmSearchRecordOne, "Search Record One", "SearchRecordOneClick");
    	    ...
    	    //Utility.ng_SelectList(edtSupplierSite, "Supplier Site", "SupplierSiteSelect");
    	    Utility.ng_clickWebElement(btnOkAddToDocBuilder, "Ok AddToDocBuilder", "OkAddToDocBuilderClick");
    	    ...
    	    Utility.ng_clickWebElement(btnOkPurchaseOrder, "Ok Purchase Order", "OkPurchaseOrderClick");
    	    ...
    	    Utility.ng_clickWebElement(btnOkConfPurchaseOrder, "Ok Conf Purchase Order", "OkConfPurchaseOrderClick");
    	    ...
    	    Utility.ng_clickWebElement(btnOkPurchaseOrderNumber, "Ok PurchaseOrderNumber", "OkPurchaseOrderNumberClick");
    ...
    public void createInvioce() throws Exception {    	
        ...
        try {
    	    ...
    	    Utility.ng_clickWebElement(elmBillToSearchRecord, "Bill To Search Record", "BillToSearchRecordClick");
    	    Utility.ng_clickWebElement(btnBillToSearchOk, "BillToSearch Ok", "BillToSearchOkClick");
    	    ...
    	    Utility.ng_clickWebElement(btnOkTransaction, "Ok Confirmation", "OkConfirmationClick");
    ...
    /*----------------------------------------------------------------------------
    Function Name    	: createPaymentQC
    Description     	: createPaymentQC  
    Author				:
    Date of creation	:
	Date of modification:
    ----------------------------------------------------------------------------*/ 
    public void createPaymentQC() throws Exception {    	
        if(Global.objErr == "11"){
            return;
        }    
        try {
    	    ...
    	    Utility.ng_SelectList(lstBusinessUnitPayment, "Business Unit", "BusinessUnitPaymentSelect");
    	    Utility.ng_typeAndTab(lstSupplierOrParty, "Supplier or Party", "SupplierOrPartySelect");
    	    Utility.ng_SelectList(lstSupplierSite, "Supplier Site", "SupplierSiteSelect");
    	    ...
    	    Utility.ng_SelectList(lstDisbursementBankAccount, "Disbursement Bank Account", "DisbursementBankAccountSelect");
    	    Utility.ng_SelectList(lstPaymentMethod, "Payment Method", "PaymentMethodSelect");
    	    Utility.ng_SelectList(lstPaymentProcessProfile, "Payment Process Profile", "PaymentProcessProfileSelect");
    	    Utility.ng_SelectList(lstPaymentDocument, "Payment Document", "PaymentDocumentSelect");
    	    Utility.ng_clickWebElement(imgSelectAndAdd, "Select AndAdd", "SelectAndAddClick");
    	    Utility.ng_enterText(edtInvoiceNumber, "Invoice Number", "InvoiceNumberSet");
    	    Utility.ng_clickWebElement(btnSearchInvoice, "Search Invoice", "SearchInvoiceClick");
    	    ...
    	    Utility.ng_clickWebElement(btnOkInvoicetoPay, "Ok Invoice to Pay", "OkInvoicetoPayClick");
    	    ...
    	    Utility.ng_clickWebElement(elmOkConfPayment, "Ok Conf Payment", "OkConfPayment");
	...
	public void createAndPostJournal()
	{
		...
		try {
			...
			Utility.ng_clickWebElement(btnJPost, "Post", "PostClick");

			//Utility.ng_getElementText(eleCompletionStatus, "CompletionStatus", "ConfCompletionStatus");
			Utility.ng_getElementText(elmConfJournal, "Conf Journal", "ConfJournalGet");
			Utility.ng_clickWebElement(btnOkJournal, "Ok Conf Journal", "OkConfJournalClick");
	...
	public void createReceivingReceipt()
	{
		...
		try {
			...
			Thread.sleep(5000);
			Utility.waitForPageToLoad();
			//Utility.ng_DropDown(edtItemsDue, "ItemsDue", "ItemsDueSet");
			...
			{
		    Global.gstrReadfromTestData = false;
			Utility.ng_enterText(edtPurOrder, "PurchaseOrder", PoNo);
			Global.gstrReadfromTestData = true;
			}
			else
			{
			Utility.ng_enterText(edtPurOrder, "PurchaseOrder", "PurchaseOrderSet");
			}
			...
			Utility.waitForPageToLoad();
			Thread.sleep(9000);
			Utility.ng_clickWebElement(eleCod, "CodBu", "CodBuClick");
  ...
  ----------------------------------------------------------------------------*/ 
	public void createPurOrderMatchedInvoice()
	{
		...
		try {
			...
			{
			Global.gstrReadfromTestData = false;
			Utility.ng_typeAndTab(edtIdentifyingPO, "IdentifyingPO", PoNo);
			Global.gstrReadfromTestData = true;
			Thread.sleep(5000);
			Utility.waitForPageToLoad();
			}
			...
			Global.gstrReadfromTestData = false;
			InvcNo ="InvNo"+Utility.ng_RandomNum();
			Utility.ng_typeAndTab(edtNumber, "Number", InvcNo);
			Global.gstrReadfromTestData = true;
	...
	public void createPaymentQuickCheck() throws Exception {    	
		...
		try {
			...
			//Global.gstrReadfromTestData = false;
			//Utility.ng_enterText(edtInvoiceNumber, "Invoice Number", InvcNo);
			//Global.gstrReadfromTestData = true;
